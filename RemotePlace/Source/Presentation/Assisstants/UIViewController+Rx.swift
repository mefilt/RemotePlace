...
extension UIViewController {
    ...
    var viewAppearanceEvent: Observable<ViewAppearanceEvent> {

        let willAppear = rx.viewWillAppear.map { _ in ViewAppearanceEvent.willAppear }
        let didAppear = rx.viewDidAppear.map { _ in ViewAppearanceEvent.didAppear }
        let willDisappear = rx.viewWillDisappear.map { _ in ViewAppearanceEvent.willDisappear }
        let didDisappear = rx.viewDidDisappear.map { _ in ViewAppearanceEvent.didDisappear }

        return Observable.merge([willAppear,
                                 didAppear,
                                 willDisappear,
                                 didDisappear])
    }
